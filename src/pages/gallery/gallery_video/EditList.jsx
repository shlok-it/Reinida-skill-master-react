...
const EditList = (props) => {
  ...
  const [apiurl, setApiurl] = useState("gallery/updateVideo");
  const [error, setError] = useState([]);
  const [values, setValues] = useState({
    id: props.employee.id,
    title: props.employee.v_title,
    v_id: props.employee.v_id,
    v_link:props.employee.v_link,
  ...
  return (
    ...
    >
      ...
      >
        <CardText>Update Video Link</CardText>
      </ModalHeader>
      <ModalBody>
