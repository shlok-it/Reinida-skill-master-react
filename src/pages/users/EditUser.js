...
const EditUser = (props) => {
    ...
    const [values, setValues] = useState({
        ...
        mobile: props.employee.contact,
        mobile2: props.employee.mobile2,
        email: props.employee.email,
        category: props.employee.category,
        addhar_card: props.employee.addhar_card,
        pan_card: props.employee.pan_card,
        health_issues: props.employee.health_issues,
        blood_group: props.employee.blood_group,
        //current_address
        block_id: props.employee.block_id,
        district_id: props.employee.district_id,
        state_code: props.employee.state_code,
        address: props.employee.address,
        pincode: props.employee.pincode,
        //permanent_address
        p_block_id: props.employee.p_block_id,
        p_district_id: props.employee.p_district_id,
        p_state_code: props.employee.p_state_code,
        p_address: props.employee.p_address,
        p_pincode: props.employee.p_pincode,
        //account detail
        ac_h_name: props.employee.ac_h_name,
        bank_name: props.employee.bank_name,
        ac_no: props.employee.ac_no,
        branch: props.employee.branch,
        ifsc: props.employee.ifsc,
        checked_same: props.employee.checked_same,
        //extra
        // qualifications: '',
        // exp_year: '',
        // exp_month: '',
    ...
    const submitThis = (e) => {
        ...
        if (values.gender == '') {
            ...
            setLoading(true);
            call_secure_api('users/update', values)
                .then(
                    (resolve) => {
    ...
    return (
        <Modal size={"lg"} fade={false} isOpen={true} backdrop="static" keyboard={false}>
            <ModalHeader close={<button type={'button'} className="btn-close" onClick={() => { props.model_handler(false) }}></button>}><CardText>Update Teacher</CardText></ModalHeader>
            <ModalBody>
                <form action="" onSubmit={submitThis}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4 form-group">
                            ...
                            <input className="form-control form-control-sm" type="text" value={values.father_name} placeholder="Father Name" name="father_name" onChange={set('father_name')} maxLength={100} />
                        </div>
                    ...
                    <div className="form-group row">
                        <div className="col-sm-12">
                            ...
                            <textarea className="form-control" rows="2" name="health_issues" defaultValue={values.health_issues} onChange={set('health_issues')} placeholder="Health Issues" maxLength={150}></textarea>
                        </div>
                    </div>
