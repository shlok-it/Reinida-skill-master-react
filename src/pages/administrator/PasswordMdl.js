...
const PasswordMdl = (props) => {
    ...
    const [values, setValues] = useState(props.administrator);
    const submit_emp_password_update = (e) => {
        ...
        if (values.master_password == '') {
            ...
            setLoading(true);
            call_secure_api('administrator/password', { 'administrator_id': values.id, password: values.master_password })
                .then(
                    (resolve) => {
                ...
                <form action="" onSubmit={submit_emp_password_update}>
                    <div className="form-group row">
                        <div className="col-sm-12">
                            ...
                            <input className="form-control form-control-sm" type="text" value={values.master_name} disabled />
                        </div>
                        <div className="col-sm-12">
                            <label className="col-form-label form-label">Contact</label>
                            <input className="form-control form-control-sm" type="text" value={values.master_mobile} disabled />
                        </div>
                        <div className="col-sm-12">
                            <label className="col-form-label form-label">Email</label>
                            <input className="form-control form-control-sm" type="text" value={values.master_email} disabled />
                        </div>
                        <div className="col-sm-12">
                            <label className="col-form-label form-label">Password</label>
                            <input className="form-control form-control-sm" type="text" name="master_password" value={values.master_password} onChange={set('master_password')} />
                        </div>
                    </div>
